  ...
  return (
    <div className="flex flex-col h-full w-full max-w-lg mx-auto pt-10 px-6 animate-fade-in">
      <div className="mb-10 text-center border-b-2 border-black pb-4">
         <h1 className="text-2xl font-bold uppercase tracking-widest text-ink-black">
            Subway Archives
         </h1>
      ...
      <div className="flex-1 space-y-8">
        <div className="p-6 border-2 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="text-sm font-bold uppercase mb-4 border-b-2 border-black pb-2">Filter Signal</h3>
            
            <div className="flex flex-col space-y-4">
                <div className="flex flex-col space-y-2">
                    <label className="text-xs font-bold uppercase">Target Industry</label>
                    <select 
                        value={industry} 
                ...
                <div className="flex flex-col space-y-2">
                    <label className="text-xs font-bold uppercase">Advice Request</label>
                    <select 
                        value={adviceType} 
        ...
        <div className="text-center text-xs font-bold text-gray-500 max-w-xs mx-auto">
      ...
      <div className="pb-10 space-y-4">
        <button 
            ...
            className="w-full py-4 bg-black text-white text-sm font-bold uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(100,100,100,0.5)] hover:bg-gray-800 transition-all hover:translate-y-1 hover:shadow-none"
        >
            Locate Random Can
        </button>
        <button 
            onClick={onBack}
            className="w-full py-3 text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-black underline"
        >
            Return to Station
        </button>
      </div>
